...
router.get('/doc', oauthScopes(swaggerDocument, extractor), (req, res, next) => {
  try {
    res.send('ok');
  } catch (e) {
    console.error('Error while processing request: ', e);
...
router.get(
  '/doc-explicit',
  oauthScopes(swaggerDocument, extractor, 'oauth', '/explicitly-doc'),
  (req, res, next) => {
    try {
      res.send('ok');
    } catch (e) {
...
router.get('/wrong', oauthScopes(swaggerDocument, extractor), (req, res, next) => {
  try {
    res.send('ok');
  } catch (e) {
    console.error('Error while processing request: ', e);
